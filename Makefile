...
# Copyright (c) UNSPECIFIED - FILL IN, 2020 
# 
...
SUBSYSTEM = "AWV - move javarias\' telescope @ home"

MODULES:= ICD EXTERNAL/Serial EXTERNAL/Canon EXTERNAL/Nexstar EXTERNAL/Camera \
	  cppTelescope jTelescope pyTelescope \
