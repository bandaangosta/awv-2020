...
/* Command-line: /alma/ACS-2020JUN/TAO/ACE_wrappers/build/linux/bin/ace_gperf -m -M -J -c -C -D -E -T -f 0 -F 0,0 -a -o -t -p -K opname -L C++ -Z TAO_TELESCOPE_MODULE_Telescope_Perfect_Hash_OpTable -N lookup  */
unsigned int
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"moveTo", &POA_TELESCOPE_MODULE::Telescope::moveTo_skel, 0},
      {"observe", &POA_TELESCOPE_MODULE::Telescope::observe_skel, 0},
      {"",0,0},
      ...
      {"",0,0},{"",0,0},{"",0,0},
      {"getCurrentPosition", &POA_TELESCOPE_MODULE::Telescope::getCurrentPosition_skel, 0},
    };
...
POA_TELESCOPE_MODULE::Telescope::Telescope (void)
  : TAO_ServantBase ()
{
  this->optable_ = &tao_TELESCOPE_MODULE_Telescope_optable;
}
...
const char* POA_TELESCOPE_MODULE::Telescope::_interface_repository_id (void) const
{
...
POA_TELESCOPE_MODULE::Telescope::_this (void)
{
  ...
  typedef ::TELESCOPE_MODULE::Telescope STUB_SCOPED_NAME;
  return
